	...
	<table style="width:100%">
		<tr>
        	...
        	<c:if test="${!empty movie.poster_img}">
        		<center>
        		<img src="image_View.do?movie_num=${movie.movie_num}&type=poster" width="200px"></center>
        	</c:if>
        	<c:if test="${empty movie.poster_img}">
        	등록된 포스터 없음
        	</c:if>
			...
			<ul class="list">
				...
				<li><label for="director">감독　</label>
					<input id="director" name="director" value="${movie_command.director}" size="30" class="input_director" readonly="readonly"/>　|　수정입력　<input class="auto_director" type="text"/><br>
		...
		<tr>
			...
			<ul class="list">
				...
				<li>수정 입력　<input class="auto_actor" type="text"/>
				...
				<li>
					...
					<form:textarea path="summary" cols="150" rows="8" />
