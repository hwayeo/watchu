...
<select class="visible-xs visible-sm form-control country-category all-category" name="keyword">
...
<!-- 웹환경 -->
<select id="category-menu" class="hidden-xs hidden-sm genre-category all-category" name="keyword">
		<option value="">모든 장르</option>
	<c:forEach var="cl" items="${movieGenre}">
		<option value="${cl.genre}">${cl.genre}</option>
	</c:forEach>
</select>
<select id="category-menu" class="hidden-xs hidden-sm country-category all-category" name="keyword">
  		<option value="">모든 국가</option>
    <c:forEach var="gl" items="${movieInfo}">
		<option value="${gl.country}">${gl.country}</option>
	</c:forEach>
</select>
<select id="category-menu" class="hidden-xs hidden-sm category-right order-category all-category" name="keyword"> 
  <option value="" selected>최신 순</option>
  <option value="">추천 순</option>
  <option value="rate">별점 순</option>
</select>
