...
=======
		...
		OFF_NUM                       		NUMBER		 NOT NULL,
		RATE                          		NUMBER(1)		 NOT NULL
>>>>>>> branch 'master' of https://github.com/hwayeo/watchu.git
);
...
COMMENT ON COLUMN ANALYSIS_OFFICIALS.ID is '평가자';
COMMENT ON COLUMN ANALYSIS_OFFICIALS.NAME is 'NAME';
...
COMMENT ON COLUMN ANALYSIS_GENRE.ID is '평가자';
COMMENT ON COLUMN ANALYSIS_GENRE.GENRE is '장르';
...
ALTER TABLE MOVIE_GENRE ADD CONSTRAINT IDX_MOVIE_GENRE_PK PRIMARY KEY (GENRE);
...
ALTER TABLE OFFICIALS ADD CONSTRAINT IDX_OFFICIALS_PK PRIMARY KEY (NAME);

ALTER TABLE ANALYSIS_OFFICIALS ADD CONSTRAINT IDX_ANALYSIS_OFFICIALS_FK0 FOREIGN KEY (MOVIE_NUM) REFERENCES MOVIE_INFO (MOVIE_NUM);
ALTER TABLE ANALYSIS_OFFICIALS ADD CONSTRAINT IDX_ANALYSIS_OFFICIALS_FK1 FOREIGN KEY (NAME) REFERENCES OFFICIALS (NAME);

ALTER TABLE ANALYSIS_GENRE ADD CONSTRAINT IDX_ANALYSIS_GENRE_FK0 FOREIGN KEY (MOVIE_NUM) REFERENCES MOVIE_INFO (MOVIE_NUM);
ALTER TABLE ANALYSIS_GENRE ADD CONSTRAINT IDX_ANALYSIS_GENRE_FK1 FOREIGN KEY (GENRE) REFERENCES MOVIE_GENRE (GENRE);
